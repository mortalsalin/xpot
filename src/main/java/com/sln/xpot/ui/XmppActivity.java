...
import com.sln.xpot.services.AvatarService;
import com.sln.xpot.services.XmppConnectionService;
import com.sln.xpot.services.XmppConnectionService.XmppConnectionBinder;
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
						NdefRecord.createUri(getShareableUri()),
							NdefRecord.createApplicationRecord("com.sln.xpot")
					});
				}
			}, this);
		}
