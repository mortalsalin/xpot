...
import com.sln.xpot.Config;
import com.sln.xpot.R;
import com.sln.xpot.crypto.PgpEngine;
import com.sln.xpot.entities.Account;
import com.sln.xpot.entities.Blockable;
import com.sln.xpot.entities.Bookmark;
import com.sln.xpot.entities.Contact;
import com.sln.xpot.entities.Conversation;
import com.sln.xpot.entities.Downloadable;
import com.sln.xpot.entities.DownloadablePlaceholder;
import com.sln.xpot.entities.Message;
import com.sln.xpot.entities.MucOptions;
import com.sln.xpot.entities.MucOptions.OnRenameListener;
import com.sln.xpot.entities.Presences;
import com.sln.xpot.generator.IqGenerator;
import com.sln.xpot.generator.MessageGenerator;
import com.sln.xpot.generator.PresenceGenerator;
import com.sln.xpot.http.HttpConnectionManager;
import com.sln.xpot.parser.IqParser;
import com.sln.xpot.parser.MessageParser;
import com.sln.xpot.parser.PresenceParser;
import com.sln.xpot.persistance.DatabaseBackend;
import com.sln.xpot.persistance.FileBackend;
import com.sln.xpot.ui.UiCallback;
import com.sln.xpot.utils.CryptoHelper;
import com.sln.xpot.utils.ExceptionHelper;
import com.sln.xpot.utils.OnPhoneContactsLoadedListener;
import com.sln.xpot.utils.PRNGFixes;
import com.sln.xpot.utils.PhoneHelper;
import com.sln.xpot.utils.SerialSingleThreadExecutor;
import com.sln.xpot.utils.Xmlns;
import com.sln.xpot.xml.Element;
import com.sln.xpot.xmpp.OnBindListener;
import com.sln.xpot.xmpp.OnContactStatusChanged;
import com.sln.xpot.xmpp.OnIqPacketReceived;
import com.sln.xpot.xmpp.OnMessageAcknowledged;
import com.sln.xpot.xmpp.OnMessagePacketReceived;
import com.sln.xpot.xmpp.OnPresencePacketReceived;
import com.sln.xpot.xmpp.OnStatusChanged;
import com.sln.xpot.xmpp.OnUpdateBlocklist;
import com.sln.xpot.xmpp.XmppConnection;
import com.sln.xpot.xmpp.chatstate.ChatState;
import com.sln.xpot.xmpp.forms.Data;
import com.sln.xpot.xmpp.forms.Field;
import com.sln.xpot.xmpp.jid.InvalidJidException;
import com.sln.xpot.xmpp.jid.Jid;
import com.sln.xpot.xmpp.jingle.JingleConnectionManager;
import com.sln.xpot.xmpp.jingle.OnJinglePacketReceived;
import com.sln.xpot.xmpp.jingle.stanzas.JinglePacket;
import com.sln.xpot.xmpp.pep.Avatar;
