...
import com.sln.xpot.services.XmppConnectionService.OnAccountUpdate;
import com.sln.xpot.services.XmppConnectionService.OnConversationUpdate;
import com.sln.xpot.services.XmppConnectionService.OnRosterUpdate;
import com.sln.xpot.ui.adapter.ConversationAdapter;
...
public class ConversationActivity extends XmppActivity
	...
	public static final String ACTION_DOWNLOAD = "com.sln.xpot.action.DOWNLOAD";
			...
			public void onPresenceSelected() {
				...
				switch (attachmentChoice) {
					...
					case ATTACHMENT_CHOICE_RECORD_VOICE:
						...
						fallbackPackageId = "com.sln.xpot.voicerecorder";
						break;
					case ATTACHMENT_CHOICE_LOCATION:
						intent.setAction("com.sln.xpot.location.request");
						fallbackPackageId = "com.sln.xpot.sharelocation";
						break;
				}
	...
	protected void attachFileDialog() {
		...
		if (new Intent("com.sln.xpot.location.request").resolveActivity(getPackageManager()) == null) {
